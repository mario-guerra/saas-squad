---
description: How to instrument and monitor your app for production-grade visibility.
---
...
5. **Memory**: Call `MEMORY_PROMPT.md` to finalized the pulse of your system.
6. **Dashboarding**: Once deployed, return to `OBSERVABILITY_AGENT.md` to design the "Founder's Pulse" dashboard.
